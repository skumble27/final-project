...
for country in countries_list:
    ...
    chosen_column = chosencountry['electricity_consumption_kwh'].tolist()
    chosen_column
    ...
    prediction1.to_csv(f'E:/My Documents/Professional Development/Monash University Data Analytics Boot Camp/GitHubRepo/final-project/ProphetPackage/electricity_consumption_kwh/{country}electricity_consumption_kwh.csv')
    prediction1
